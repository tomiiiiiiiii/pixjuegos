...
echo Creando Evil Pato!
cd ..\..\fpg-sources\enemigo5
del /f *.png
xcopy /r/e/y ..\pato1\*.png .
for /f %%f in ('dir /b *.png') do ..\..\..\utils\imagemagick\convert %%f -color-matrix "1 -0.5 0 1 -0.5 0 1 -0.5 0" -colorspace Gray png32:%%f
