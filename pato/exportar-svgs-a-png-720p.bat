...
echo Creando ruzafaes y patos alternativos...
cd recursos\personajes
type ruzafa.svg | ..\..\..\utils\sed "s/ff7f2a/00af00/g" > ruzafa2.svg
type ruzafa1bici.svg | ..\..\..\utils\sed "s/ff7f2a/00af00/g" > ruzafa2bici.svg
type ruzafa.svg | ..\..\..\utils\sed "s/ff7f2a/00afff/g" > ruzafa3.svg
type ruzafa1bici.svg | ..\..\..\utils\sed "s/ff7f2a/00afff/g" > ruzafa3bici.svg
type ruzafa.svg | ..\..\..\utils\sed "s/ff7f2a/8d368f/g" > ruzafa4.svg
type ruzafa1bici.svg | ..\..\..\utils\sed "s/ff7f2a/8d368f/g" > ruzafa4bici.svg
...
rd /s /q fpg-sources
mkdir fpg-sources
mkdir fpg-sources\ruzafa1
mkdir fpg-sources\ruzafa2
mkdir fpg-sources\ruzafa3
mkdir fpg-sources\ruzafa4
mkdir fpg-sources\ruzafa1bici
mkdir fpg-sources\ruzafa2bici
mkdir fpg-sources\ruzafa3bici
mkdir fpg-sources\ruzafa4bici
mkdir fpg-sources\pato1
